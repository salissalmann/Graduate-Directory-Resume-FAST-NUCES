...
<form action="#" method="post">
    ...
    <div class="the_whole"> 
        ...
        <div class="form-group">
            <label for="name"> Interest 1</label>
        ...
        <div class="basic_info">
            ...
            <div class="form-group ">
                <label for="name"> Interest 2</label>
        ...
        <div class="form-group">
            <label for="name"> Interest 3</label>
        ...
        <div class="basic_info">
            ...
            <div class="form-group ">
                <label for="name"> Interest 4</label>
        ...
        <div class="form-group">
            <label for="name"> Interest 5</label>
        ...
        <div class="basic_info">
            ...
            <div class="form-group ">
                <label for="name"> Interest 6</label>
